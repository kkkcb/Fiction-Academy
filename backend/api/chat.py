...
async def _chat_stream_generator(conversation_id: str, user_content: str, assistant_id: str = ""):
    db = await get_db()
...
async def stream_chat(conversation_id: str, body: ChatRequest):
    return StreamingResponse(
        _chat_stream_generator(conversation_id, body.content, body.assistant_id),
